...
func (o *PostUserRequest) GetProperties() map[string]GetUsersResponseUsersInnerPropertiesValue {
...
// and a boolean to check if the value has been set.
func (o *PostUserRequest) GetPropertiesOk() (map[string]GetUsersResponseUsersInnerPropertiesValue, bool) {
	if o == nil || IsNil(o.Properties) {
...
func (o *PostUserRequest) HasProperties() bool {
	if o != nil && !IsNil(o.Properties) {
		return true
	}
...
func (o *PostUserRequest) SetProperties(v map[string]GetUsersResponseUsersInnerPropertiesValue) {
	o.Properties = v
}
