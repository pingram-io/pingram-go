...
func (o *CreateOrganizationRequest) GetAttribution() map[string]string {
...
func (o *CreateOrganizationRequest) GetAttributionOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.Attribution) {
		return nil, false
	}
...
func (o *CreateOrganizationRequest) HasAttribution() bool {
	if o != nil && !IsNil(o.Attribution) {
		return true
	}
...
func (o *CreateOrganizationRequest) SetAttribution(v map[string]string) {
	o.Attribution = &v
}
