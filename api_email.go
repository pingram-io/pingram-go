...
type ApiEmailDeleteSuppressionsRequest struct {
	ctx        context.Context
...
EmailDeleteSuppressions Remove all email suppressions of the given reason for users in the environment
	...
	@return ApiEmailDeleteSuppressionsRequest
*/
func (a *EmailAPIService) EmailDeleteSuppressions(ctx context.Context, reason string) ApiEmailDeleteSuppressionsRequest {
	return ApiEmailDeleteSuppressionsRequest{
		ApiService: a,
		ctx:        ctx,
		reason:     reason,
...
func (a *EmailAPIService) EmailDeleteSuppressionsExecute(r ApiEmailDeleteSuppressionsRequest) (*DeleteEmailSuppressionsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/email/suppressions/{reason}"
	localVarPath = strings.Replace(localVarPath, "{"+"reason"+"}", url.PathEscape(parameterValueToString(r.reason, "reason")), -1)
